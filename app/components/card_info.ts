...
export const card_info = [
    {title: "Total visitor", amount: 60, perc: 12, bg_img: bg_b, img: img_p},
    {title: "Total Vehicles", amount: 60, perc: 12, bg_img: bg_g, img: img_c},
    {title: "Flagged Vehicles", amount: 60, perc: 12, bg_img: bg_r, img: img_cf},
]